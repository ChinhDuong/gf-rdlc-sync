...
namespace BJRX_v4_basic_SureMedPlusRdlc.Views
{
    public partial class RDLCReportView : INavigationAware, IRegionMemberLifetime, IActiveAware
    {
            ...
            foreach (var item in listPillGroup.OrderBy(p => p.pillId))
            {
                if (item.pillId != null)
                {
                    ...
                    if (medicine.PillInfo != null)
                    {
                        ...
                        pillInside.GenericFor = medicine.PillInfo.GenericNameShort;
                        ...
                        pillInside.RefillsRemaining = medicine.PrescriptionNumberOriginal;
                            ...
                            if (pill != null)
                            {
                                switch ((pill.cupNumber + 3) % 4)
                                {
                                    case 0:
                                        ...
                                        pillInside.DoseMorn = pill.Amount;
                                        break;
                                    case 1:
                                        pillInside.NumNoon += pill.Amount;
                                        pillInside.DoseNoon = pill.Amount;
                                        break;
                                    case 2:
                                        pillInside.NumEve += pill.Amount;
                                        pillInside.DoseEve = pill.Amount;
                                        break;
                                    case 3:
                                        pillInside.NumNight += pill.Amount;
                                        pillInside.DoseNight = pill.Amount;
                                        break;
                                    default:
                                        break;
                                }
        ...
        private List<PillDispense> GetChargeAndExpireDate()
        {
