...
namespace Mercy_SureMedPlusRdlc.Views
{
        ...
        void BindingDataToReport()
        {
            ...
            if (tray != null)
            {
                ...
                var model = new SureMedRdlcReportOutsideInfo()
                {
                    ...
                    FacilityAndDayOfWeekStr = isMultiPatient ? Linguist.Phrase("ErrorDataTitle") : cupFirst.Location.Institution.Name + "/"+ cupFirst.IntakeDateTime.ToString("dddd", string.IsNullOrEmpty(languageCode)
